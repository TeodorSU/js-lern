...
function clickHandler(event) {
    ...
    event.target.addEventListener('click', showCategory(this.dataset.type));
}
...
function getProductMarkup(product) {
    let porductType = products[product];
    porductType.forEach(function (element){
        let markUp = `
        <div class="product">
       ...
       `
      elDiv.insertAdjacentHTML("afterbegin", markUp);

  })

}
let buttonEl = document.querySelectorAll('button');
let elDiv = document.querySelector('.products');
